...
public class Reponedor extends Trabajador{
	...
	public Reponedor(Supermercado supermercado, String user, String password, String name, String dni, float salary, int entrada, int salida) {
		super(supermercado, user, password, name, dni, salary, entrada, salida);
